...
export const journeyData = [
  ...
  {
    heading: "Learning Web Technology",
    subHeading:
  ...
  {
    heading: "Krupajal Engineering College, Bhubaneswar",
  ...
  },
  {
    ...
    subHeading: "Swami Vivekananda Memorial Autonomous College, Jagatsinghpur",
    description: "Intermediate (11th and 12th)",
    duration: "2016 - 2018",
    icon: IoMdSchool,
    backgroundColor: "rgb(233, 30, 99)",
    borderColor: "rgb(233, 30, 99)",
  },
  {
    ...
    subHeading: "Mahabir Markand Memorial High school, Anantpur",
    description: "Schooling (1st standard to 10th standard )",
    duration: "2006 - 2016",
    icon: IoMdSchool,
    backgroundColor: "rgb(233, 30, 99)",
    borderColor: "rgb(233, 30, 99)",
